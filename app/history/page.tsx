...
// ===================================================================
// Interactive Card Component for Each History Item
// ===================================================================
        ...
        <div className="px-4 pb-4 border-t border-gray-700 space-y-4">
          ...
          <div className="pt-2">
            ...
            <div className="space-y-3 mt-2">
              {/*
                THE FIX IS HERE: `|| []`
                This says: "Use `item.ai_response?.scripts`, but if that is null or undefined,
                use an empty array `[]` instead." This prevents the `.map` from ever being called on `undefined`.
              */}
              {(item.ai_response?.scripts || []).map((script, index) => (
                <div key={index} className="bg-gray-700 p-3 rounded-md">
                  <div className="flex justify-between items-center mb-1">
                    ...
                    <button onClick={() => handleCopy(script.content, index)} className={`text-xs text-white font-semibold py-1 px-3 rounded-md transition-all active:scale-95 ${copiedIndex === index ? 'bg-green-600' : 'bg-gray-600 hover:bg-gray-500'}`}>
...
// ===================================================================
// Main History Page Component (No changes here)
// ===================================================================
